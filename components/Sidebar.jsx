...
const Sidebar = () => {
    ...
    return (
        <div className='bg-white sm:flex hidden rounded h-screen w-auto box text-center cursor-pointer'>
            <ul className='space-y-10  top-0  bottom-0 left-0  p-10 rounded  text-center'>
                ...
                <div className='space-y-3'>
                    <li className='flex gap-3 bg-blue-400 py-2 px-7 text-white rounded hover:opacity-50' onClick={() => window.my_modal_3.showModal()}><IoIosAddCircleOutline className='text-[25px] text-white' />Add file</li>
                    <li className='flex gap-3 bg-purple-400 py-2 px-7 text-white rounded hover:opacity-50 ' onClick={() => window.my_modal_2.showModal()}><IoIosAddCircleOutline className='text-[25px] text-white' />Folder</li>
                </div>
